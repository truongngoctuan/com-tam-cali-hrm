...
(1,'admin','icehrm+admin@web-stalk.com','4048bb914a704a0728549a26b92d8550',NULL,'Admin',NULL,NULL,NULL);
...
INSERT INTO `WorkDays` (`id`, `name`, `status`) VALUES
(1, 'Monday', 'Full Day'),
(2, 'Tuesday', 'Full Day'),
(3, 'Wednesday', 'Full Day'),
(4, 'Thursday', 'Full Day'),
(5, 'Friday', 'Full Day'),
(6, 'Saturday', 'Non-working Day'),
(7, 'Sunday', 'Non-working Day');


INSERT INTO `Settings` (`name`, `value`, `description`) VALUES
('Email: Enable', '1', '0 will disable all outgoing emails from modules. Value 1 will enable outgoing emails'),
('Email: Mode', 'SMTP', 'SMTP or SNS. SMTP = emails sent using local or a remote smtp server. SNS = Amazon SNS, which send emails trough amazon Simple notification system.'),
('Email: SMTP Host', 'localhost', 'SMTP host IP'),
('Email: SMTP Authentication Required', '0', 'Is authentication required by this SMTP server'),
