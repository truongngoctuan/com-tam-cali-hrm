...
modJsList['tabHoliDay'] = new HoliDayAdapter('HoliDay');
...
<div class="modal" id="leaveStatusModel" tabindex="-1" role="dialog" aria-labelledby="messageModelLabel" aria-hidden="true" style="display:none;width:400px;margin-top:75px;top:0;">
	...
	<div class="modal-body">
		...
		<div class="control-group">
			...
			<div class="controls">
			  	<select class="" type="text" id="leave_status" name="leave_status" value="" style="width: 225px;">
