...
EmployeeSkillAdapter.method('getFormFields', function() {
	return [
	        ...
	        [ "skill_id", {"label":"Skill","type":"select","allow-null":true,"remote-source":["Skill","id","name"]}],
...
EmployeeEducationAdapter.method('getFormFields', function() {
	return [
	        [ "id", {"label":"ID","type":"hidden"}],
	        [ "education_id", {"label":"Qualification","type":"select","allow-null":false,"remote-source":["Education","id","name"]}],
...
EmployeeCertificationAdapter.method('getFormFields', function() {
	return [
	        [ "id", {"label":"ID","type":"hidden"}],
	        [ "certification_id", {"label":"Certification","type":"select","allow-null":false,"remote-source":["Certification","id","name"]}],
	        [ "institute",  {"label":"Institute","type":"text","validation":""}],
...
EmployeeLanguageAdapter.method('getFormFields', function() {
	...
	return [
	        [ "id", {"label":"ID","type":"hidden"}],
	        [ "language_id", {"label":"Language","type":"select","allow-null":false,"remote-source":["Language","id","name"]}],
